...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var symbols_distinct, _loop_1, _i, symbols_2, symbol, ds, _a, symbols_distinct_1, symbol, results;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    _loop_1 = function (symbol) {
                        if (symbols_distinct.findIndex(function (s) { return s === symbol; }) === -1) {
                            symbols_distinct.push(symbol);
                        }
                    };
                    for (_i = 0, symbols_2 = symbols_1.symbols; _i < symbols_2.length; _i++) {
                        symbol = symbols_2[_i];
                        _loop_1(symbol);
                    }
                    console.log('Opening data file');
                    ds = JSON.parse(fs.readFileSync('./storage/ds.json', { encoding: 'utf8' }));
                    _a = 0, symbols_distinct_1 = symbols_distinct;
                    _b.label = 1;
                case 1:
                    if (!(_a < symbols_distinct_1.length)) return [3 /*break*/, 4];
                    symbol = symbols_distinct_1[_a];
